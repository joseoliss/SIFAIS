...
namespace SIFAIS.Datos.ActivosPrestados
{
    public interface IActivosPrestadosBLL
    {
        ...
        Respuesta ListActivosPrestadosRep(ApplicationDbContext context, string Tipo, string Estado, DateTime Desde, DateTime Hasta);
        Respuesta ListHistorialPrestamos(ApplicationDbContext context);
        Respuesta ListHistorialPrestamosRep(ApplicationDbContext context, string Tipo, string Estado, DateTime Desde, DateTime Hasta);
